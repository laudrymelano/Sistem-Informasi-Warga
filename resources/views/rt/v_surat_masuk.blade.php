        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title font-weight-bold mr-2 mt-2" style="color: teal">Detail Surat Masuk</h3>
                </div>
                <!-- /.card-header -->
                            ...
                            @foreach ($datas as $key => $data)
                                <tr>
                                    ...
                                    <td class="text-center align-middle">
                                        <a href="#" class="btn btn-light bg-teal btn-sm aprrove" update='accept'
                                            nama="{{ $data->nama }}" id-surat="{{ $data->id }}"><i
                                                class="fas fa-check"> Setuju</i> </a> &nbsp;
                                        <a href="#" class="btn btn-light bg-maroon btn-sm reject" update='reject'
                                            nama="{{ $data->nama }}" id-surat="{{ $data->id }}"> <i
                                                class="fas fa-times"> Tolak</i></a>
                                    </td>
                                </tr>
                                <?php $no++; ?>
                            @endforeach
