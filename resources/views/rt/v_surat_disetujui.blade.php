            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title font-weight-bold mr-2 mt-2" style="color: teal">Detail Surat Disetujui</h3>
                        <div class="card-tools">
                            <div class="container">
                                <form action="/rt/cari/surat" method="post">
                                    @csrf
                                    <div class="input-group">
                                        <a href="{{ url('/rt/surat/disetujui') }}" class="btn btn-light bg-teal"
                                            style="margin-right: 10px">Semua Data</a>
                                    ...
                                    <tr>
                                        ...
                                        @if ($data->id_status_surat == '3')
                                            <td class="text-center align-middle">
                                                <a href="{{ url('/view/surat/rt/' . $data->id) }}" target="_blank"
                                                    class="btn btn-light bg-teal btn-sm"><i class="fas fa-file-download">
                                                        Download</i> </a> &nbsp;
                                            </td>
                                        @endif
                                    </tr>
