                        ...
                        <tbody class="list">
                            ...
                            <tr>
                                ...
                                <td class="text-center align-middle">
                                    ...
                                    <a href="#" class="btn btn-light bg-teal btn-sm" data-toggle="modal" data-target="#editModalBerita{{$data->id}}"><i class="fas fa-edit"></i></a> &nbsp;
                                    <a href="#" class="btn btn-danger btn-sm delete" judul= "{{$data->judul}}" id-berita ="{{$data->id}}"> <i class="fas fa-trash-alt"></i></i></a>
                                </td>
                            </tr>
                            <?php $no++; ?>
                            @endforeach
...
<!-- Start Modal -->
  <!-- Add Modal -->
  <div class="modal fade" id="addModalBerita" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        ...
        <div class="modal-body">
            {{-- <form> --}}
                <div class="form-group">
                    ...
                    <input type="text" value="{{old('judul')}}" class="form-control" id="judul" name="judul" placeholder="Masukkan judul post">
                    @error('judul')
                ...
                <div class="form-group">
                    <label for="gambar1" class="form-label">Gambar (Opsional)</label>
                    <img class="img-preview1 img-fluid mb-2 col-sm-4">
                    <input class="form-control" type="file" id="gambar1" name="gambar1" onchange="previewImage1()">
                    @error('gambar1')
                    <div class="text-danger mt-2">
                        {{$message}}
                    </div>
                ...
                <div class="form-group">
                    <label for="gambar2" class="form-label">Gambar (Opsional)</label>
                    <img class="img-preview2 img-fluid mb-2 col-sm-4">
                    <input class="form-control" type="file" id="gambar2" name="gambar2" onchange="previewImage2()">
                    @error('gambar2')
                    <div class="text-danger mt-2">
                        {{$message}}
                    </div>
...
<!-- Start Modal -->
  ...
  <div class="modal fade" id="editModalBerita{{$data->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl" role="document">
      <div class="modal-content">
        <div class="modal-header">
        ...
        <form action="/berita/edit/{{$data->id}}" method="POST" id="editBerita" enctype="multipart/form-data">
            @csrf
            @method('PUT')
        <div class="modal-body">
            {{-- <form> --}}
                <div class="form-group">
                    ...
                    <input type="text" value="{{ $data->judul }}" class="form-control" id="judulEdit" name="judulEdit" placeholder="Masukkan judul post">
                    @error('judulEdit')
                    <div class="text-danger mt-2">
                        {{$message}}
                    </div>
                ...
                <div class="form-group">
                    ...
                    <img class="img-preview-edit{{$data->id}} img-fluid mb-3 col-sm-5 d-block" src="{{asset('storage/'. $data->thumbnail)}}">
                ...
                <div class="form-group">
                    ...
                    <img class="img-preview-edit1{{$data->id}} img-fluid mb-3 col-sm-5 d-block" src="{{asset('storage/'. $data->gambar1)}}">
                    <input type="hidden" id="oldImage1" name="oldImage1" value="{{$data->gambar1}}">
                    <input class="form-control" type="file" id="thumbnailEdit1{{$data->id}}" name="thumbnailEdit1" onchange="previewImageEdit1({{$data->id}})">
                ...
                <div class="form-group">
                    ...
                    <img class="img-preview-edit2{{$data->id}} img-fluid mb-3 col-sm-5 d-block" src="{{asset('storage/'. $data->gambar2)}}">
                    <input type="hidden" id="oldImage2" name="oldImage2" value="{{$data->gambar2}}">
                    <input class="form-control" type="file" id="thumbnailEdit2{{$data->id}}" name="thumbnailEdit2" onchange="previewImageEdit2({{$data->id}})">
