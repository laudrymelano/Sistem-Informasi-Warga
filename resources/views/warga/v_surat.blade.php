    ...
    <div class="row" style="padding-top:3cm; padding-bottom:2cm">
        ...
        <div class="card col-md-9 mx-auto shadow rounded">
            ...
            <div class="col-md-12 text-center" style="margin-bottom:3vh;">
                <button id="lanjut" class="btn btn-icon btn-outline-primary rounded-pill btn-sm">Oke, Saya Mengerti</button>
            </div>
        </div>
        <div id="form-surat" class="card col-md-9 mx-auto shadow rounded" style="margin-top:20px; margin-bottom: 20px; display: none" x>
                ...
                <div class="row"  >
                    <div class="form-group col-md-9 mb-3" >
                        ...
                        <select class="form-select" name="keperluan" aria-label="Default select example">
                            ...
                            <option value="Mutasi Tanah, Jual Beli/Hibah/Waris">Mutasi Tanah, Jual Beli/Hibah/Waris</option>
                    ...
                    <div class="form-group col-md-9 mb-3" >
                    <label for="keperluan-lainnya" class="form-label">Lainnya <i style="color: red; font-size: 13px">(Jika pilihan tidak tersedia pada opsi diatas)</i></label>
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input class="form-control" name="fileKTP" type="file" id="KTP">
                        @error('fileKTP')
                              <div class="text-danger mt-2">
                                  {{$message}}
                              </div>
                    ...
                    <div class="form-group mb-4">
                        ...
                        <input class="form-control" name="fileKK" type="file" id="KK">
                        @error('fileKK')
                          <div class="text-danger mt-2">
                              {{$message}}
                          </div>
