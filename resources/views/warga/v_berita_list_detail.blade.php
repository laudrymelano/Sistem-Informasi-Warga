    ...
    <section class="inner-page">
      <div class="container">
        <section id="thumbnail" style="padding-top: 0px;">
            ...
            <a class="btn btn-primary btn-sm" href="{{ asset('storage/'.$db->attachment)}}" target="_blank"><i class="fa fa-file"></i></a>
            @endif
            @if ( Str::length(Auth::guard('user_warga')->user())>0)
            <div class="row float-end">
              <div class="col-md-4 ">
                <a href="{{url('/beranda/berita/list')}}" class="btn btn-icon btn-secondary rounded-pill btn-sm" style="margin-top: 40px" type="submit">Kembali</a>
            </div>
            @else
            <div class="row float-end">
              <div class="col-md-4">
                <a href="{{url('/berita/list')}}" class="btn btn-icon btn-secondary rounded-pill btn-sm" style="margin-top: 40px" type="submit">Kembali</a>
            </div>
          </div>
          @endif
        </section>
